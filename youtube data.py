...
Api_key = 'AIzaSyDZd7hFG1pvN8ocf-vwpDRzpceZbQFIaSU'
...
with tab1:
    if st.button("migarte to Mongodb"):
        ...
        client = MongoClient("mongodb+srv://adarsh120292:8me1Ext0risyk23d@cluster0.8kxfcs3.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
