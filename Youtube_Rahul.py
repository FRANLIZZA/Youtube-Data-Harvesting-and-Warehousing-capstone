...
api_version = "v3"
api_Key="AIzaSyCkhlMmE4G1fxmHap30_klTL4BzcYAgWro"
...
icon=Image.open(r"C:\Users\maria\youtube.png.png")
st.set_page_config(page_title='YouTube Data Harvesting and Warehousing',
                    page_icon=icon,
                    layout='wide',
                    initial_sidebar_state='expanded',
                    menu_items={'About': '''This streamlit application was developed by Fran lizza M.
                                Contact_e-mail:franlizza@gmail.com'''})
...
if selected == "Home":
    ...
    st.markdown('#### linkedin: www.linkedin.com/in/fran-lizza-m-07b168132')
    st.markdown('#### Email : franlizza@gmail.com')
