...
# Your API Key here
API_KEY = 'AIzaSyCz7Nke1Wfe_x66dzl969PmjCTl8GbfGQI'
...
channel_ids = [
    "UCNU_lfiiWBdtULKOw6X0Dig", 'UC7cs8q-gJRlGwj4A8OmCmXg', 'UCh9nVJoWXmFb7sLApWGcLPQ',
    'UCCWi3hpnq_Pe03nGxuS7isg', 'UCHNO_Y3DskuKiw9VTvo8AMw', 'UCeVMnSShP_Iviwkknt83cww',
    'UCWJ4ie3KEy_IAi3hnNstjwg', 'UC0Qoz2j2WmuvWTPo6XMon6Q', 'UC9JWnvl5ZjZv09F5RqiLptw',
    'UCWegChjG2YNdVMobQEMxolQ'
]
...
selected_channel_id = st.selectbox("Select a channel ID", channel_ids)
...
if selected_channel_id:
    ...
    tab1, tab2 = st.tabs(["Data", "Queries"])
